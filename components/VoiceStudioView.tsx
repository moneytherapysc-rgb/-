        ...
        <ProtectedRoute>
            <div className="max-w-6xl mx-auto font-sans animate-fade-in-up pb-12">
                ...
                <div className="text-center mb-10 pt-8">
                    ...
                    <div className="max-w-3xl mx-auto bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl p-4 text-sm text-slate-600 dark:text-slate-300 flex gap-3 items-start">
                        <InformationCircleIcon className="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" />
                        <div>
                            <p className="font-bold text-slate-800 dark:text-slate-100 mb-1">⚡ 글자 수 제한 및 속도 최적화</p>
                            <p className="opacity-90">
                                긴 텍스트는 생성 시간이 늘어납니다. <br />
                                최대 <span className="font-bold text-red-500">300자</span>로 제한하여 3~5초 내 빠른 생성이 가능합니다.
                            </p>
                        </div>
                    </div>
                </div>
